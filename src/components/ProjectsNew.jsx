  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-black max-w-4xl font-['Inter']">
          Featured Projects & Achievements
        </h2>
        <p className="text-neutral-700 text-sm md:text-base max-w-sm font-['Inter']">
        ...
        {projectData.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-neutral-500 font-['Inter']">
                {item.title}
              </h3>
            </div>

            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block text-2xl mb-4 text-left font-bold text-neutral-500 font-['Inter']">
                {item.title}
              </h3>
              {item.content}
            </div>
...
const PSAProject = () => {
  ...
  return (
    <>
      <div className="mb-8">
        <h4 className="text-2xl md:text-3xl font-bold text-black mb-4 font-['Inter']">
          🏆 PSA PORTNET AI - Incident Management
        </h4>
        <p className="text-neutral-700 text-base mb-6 font-['Inter']">
        ...
        <motion.button
          ...
          className="flex items-center gap-3 px-6 py-3 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors font-['Inter']"
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
        >
        ...
        <div className="flex flex-wrap gap-2 mt-6">
          {["Python", "LangGraph", "FastAPI", "OpenAI", "FAISS", "n8n"].map((tech) => (
            <span
              key={tech}
              className="px-3 py-1 bg-neutral-100 text-neutral-700 rounded-full text-sm font-['Inter']"
            >
              {tech}
            </span>
          ))}
